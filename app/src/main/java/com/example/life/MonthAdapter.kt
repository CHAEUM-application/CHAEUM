...
class MonthAdapter(private val year: Int) : RecyclerView.Adapter<MonthViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MonthViewHolder, position: Int) {
        ...
        holder.weeksRecyclerView.adapter = WeekAdapter(numberOfWeeks, holder.itemView.context, year, months[position])
    }
